...
class EditCompany extends Component {
  ...
  */
   ...
   */
    getEditCompData() {
        var url = 'http://192.168.10.40:3210/getCompData/' + this.props.location.state.comp_id;
    ...
    editCompany() {
        ...
        var url = 'http://192.168.10.40:3210/editCompReq/' + this.props.location.state.comp_id;
        axios.post(url, {
